...
%  Då är v1.0 lanserad https://github.com/ETSF20-Group2/E-KYSS/releases/tag/v1.0 Dokumenten som beskriver installationen behöver uppdateras med att:
% 
% 1.  Man behöver skapa databasen 'pusp1702hbg':     CREATE DATABASE pusp1702hbg;
% 2. Man behöver importera database.sql-filen till databasen genom kommandot: 
%               mysql -u pusp1702hbg -p -h vm23.cs.lth.se pusp1702hbg < database.sql
% 
% Sen behöver man kanske specificera vilka användare som finns:
% 
% Administratör:
%        anv.:   admin
%       lös.:     adminp
...
\item Databasen \textit{pusp1702} behöver skapas, efter vilket \textit{database.sql} behöver importeras in till databasen.
