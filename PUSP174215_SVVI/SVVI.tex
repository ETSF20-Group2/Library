...
\subsection*{FT20 Ny loggfil skapas när ny proejktgrupp skapas}
Förkrav: Det finns inte någonprojektgrupp med namnet “Loggtest”, admin är
inloggad.
\newline
Slutkrav: Loggfilen visas för admin med ett inlägg från tidpunkten när
projektgruppen skapades av användare admin.
...
\begin{enumerate}
  ...
  \item      Det enda inlägget i loggfilen är från ett par minuter sedan då
  gruppen skapades av användare admin
  
\end{enumerate}


\subsection*{FT21 Loggfieln för projektgruppen uppdateras för varje ändring I projektgruppen}
...
\newline
Slutkrav:  Loggfilen visas för addmin med ett inlägg för varje ändring som har
skett samt ett från då gruppen skapades.
...
\subsection*{FT22 Loggfieln raderas när en projektgrupp raderas från systemet}
...
\subsection*{FT23 Ett inlägg i loggfilen innehåller tidsstämpel samt användare}
Förkrav: Projektgruppen “Loggtest ” finns i systemet, minst en ändring har
gjorts i gruppen sedan den skapades, admin är inloggad.
\newline
...
\begin{enumerate}
  \item       Admin väljer “Loggfile” i menyn
  \item       En sida där admin uppmanas att välja vilken loggfil som ska visas
  genom att kryssa i en ruta
  \item       Admin väljer att visa loggfilen för den nyligen skapade gruppen “Loggtest”
  \item       Den valda loggfilen läses in och visas för admin
  \item       Admin kan när och av vem som varje ändring I gruppen har gjorts
