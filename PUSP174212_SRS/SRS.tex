...
\begin{figure}[H]
\centering
\includegraphics[width = 9cm]{Kontext_Diagram2.png} 
...
\item Aktivitet
\item Vecka
\item \sout{Fas} 170322
\item Dokument
	\end{enumerate}
\end{enumerate}
\subsubsection{Krav:}
\sout{Projektledaren ska i statistiken kunna se start för varje fas.} 170322
\subsubsection{Krav:}
\sout{Projektledaren ska i statistiken kunna se slut för varje fas.} 170322
